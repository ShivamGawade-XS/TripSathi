...
const chatStrings: Record<string, Record<string, string>> = {
  en: {
    ...
    fallback: "Thanks for your message! For detailed assistance, please email support@tripsathi.com or call 1800-TRIP-SAT (toll-free). Our team is available 24/7. 🌟",
  },
  hi: {
    ...
    cancel: "यात्रा से 48 घंटे पहले तक पूर्ण रिफंड के लिए बुकिंग रद्द कर सकते हैं। डैशबोर्ड → मेरी बुकिंग → रद्द करें पर जाएं। मदद के लिए 1800-TRIP-SAT पर कॉल करें।",
    ...
    complaint: "यह सुनकर दुख हुआ। कृपया अपनी बुकिंग संदर्भ संख्या के साथ support@tripsathi.com पर ईमेल करें। हमारी टीम 2 घंटे में जवाब देगी।",
    ...
    fallback: "आपके संदेश के लिए धन्यवाद! विस्तृत सहायता के लिए support@tripsathi.com पर ईमेल करें या 1800-TRIP-SAT (टोल-फ्री) पर कॉल करें। हमारी टीम 24/7 उपलब्ध है। 🌟",
  },
  ta: {
    ...
    complaint: "இதைக் கேட்டு வருந்துகிறேன். உங்கள் புக்கிங் குறிப்பு எண்ணுடன் support@tripsathi.com க்கு மின்னஞ்சல் அனுப்பவும்.",
    ...
    fallback: "உங்கள் செய்திக்கு நன்றி! விரிவான உதவிக்கு support@tripsathi.com அல்லது 1800-TRIP-SAT (கட்டணமில்லா) அழைக்கவும். 🌟",
  },
  te: {
    ...
    complaint: "అది విని బాధగా ఉంది. మీ బుకింగ్ రిఫరెన్స్ నంబర్‌తో support@tripsathi.com కు ఇమెయిల్ పంపండి.",
    ...
    fallback: "మీ సందేశానికి ధన్యవాదాలు! వివరమైన సహాయం కోసం support@tripsathi.com లేదా 1800-TRIP-SAT (టోల్-ఫ్రీ) కి కాల్ చేయండి. 🌟",
  },
  mr: {
    title: "ट्रिपसाथी मदत",
    ...
    complaint: "हे ऐकून वाईट वाटले. तुमच्या बुकिंग संदर्भ क्रमांकासह support@tripsathi.com वर ईमेल करा.",
    ...
    fallback: "तुमच्या संदेशाबद्दल धन्यवाद! तपशीलवार मदतीसाठी support@tripsathi.com वर ईमेल करा किंवा 1800-TRIP-SAT (टोल-फ्री) वर कॉल करा. 🌟",
  },
}
